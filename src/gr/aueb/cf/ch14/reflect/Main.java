...
//            Constructor<?> defaultCtr = clazz.getConstructor(); prosvash mono sta public
            Constructor<?> defaultCtr = clazz.getDeclaredConstructor();
            defaultCtr.setAccessible(true);
//            with getDeclaredConstructor(); gia na paroume prosvash k sta private
//            kai meta default.setAccessible(true)
