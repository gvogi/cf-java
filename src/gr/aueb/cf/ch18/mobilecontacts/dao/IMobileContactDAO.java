...
public interface IMobileContactDAO {
     ...
     *
     * @param mobileContact the model object that contains
     *                      the mobile contact data.
     *
    ...
    /**
     * Updates a new {@link MobileContact} instance.
     *
     * @param mobileContact the model object that contains
     *                      the mobile contact data.
     *
    ...
    /**
     * Returns all the mobile contact instances from the data source
     *
     ...
     *
     * @return true if the <code>phoneNumber</code> exists in {@link MobileContact}
     * in the datasource.
     */
     ...
     *
     * @return true if the <code>id</code> exists in {@link MobileContact}
     * in the datasource.
     */
