...
public class MobileContactServiceImpl implements IMobileContactService {
    ...
    @Override
    public MobileContact insertMobileContact(MobileContactDTO mobileContactDTO) throws PhoneNumberAlreadyExistsException,
     ...
     *
     * @param mobileContactDTO the mobile Contact transfer object.
     */
     ...
     *
     * @param userDetailsDTO the mobile Contact transfer object.
     */
